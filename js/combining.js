	...
	return {
		...
		load: function () {
			jQuery("select").length && jQuery("select").selectpicker(), jQuery("input[name='demo_vertical2']").TouchSpin({
				...
				}(), jQuery("body").append('\x3c!-- Go to www.addthis.com/dashboard to customize your tools --\x3e<script type="text/javascript" src="../../s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5b221c5e31b4e54b"><\/script>')
		},
		resize: function () {
...
function setThemePanel() {
	jQuery.each(themeOption, function (e, i) {
		if (themeOptionItemValue = getCookie(i + "_value"), "" != themeOptionItemValue)
			if ("themeStandardColor" == i) jQuery(".skin").attr("href", themeOptionItemValue + ".css"), setThemeLogo(i);
			else if ("themeFullColor" == i) jQuery(".skin").attr("href", themeOptionItemValue + ".css"), setThemeLogo(i);
		else if ("layout" == i) jQuery("." + i + "-view li").removeClass("active"), jQuery("." + i + "-view").find("." + themeOptionItemValue).addClass("active"), "frame" == themeOptionItemValue ? (jQuery("#ThemeRangeSlider").show("slow"), jQuery("body").addClass(themeOptionItemValue), themeOptionFrameValue = getCookie("frame_value"), "" == themeOptionFrameValue && (themeOptionFrameValue = 20), jQuery("#FramePadding").val(themeOptionFrameValue + "px"), jQuery("#bg").css("padding", themeOptionFrameValue + "px")) : jQuery("body").addClass(themeOptionItemValue);
		else if ("header" == i) jQuery("." + i + "-view li").removeClass("active"), "sticky-header" == themeOptionItemValue ? jQuery("." + i + "-view").find(".header-fixed").addClass("active") : "sticky-no" == themeOptionItemValue && jQuery("." + i + "-view").find(".header-static").addClass("active"), jQuery(".main-bar-wraper").addClass(themeOptionItemValue);
		else if ("menubar" == i) {
		...
		} else "bgColor" == i ? (jQuery("#bg").css("background-color", themeOptionItemValue), jQuery("#bg").css("background-image", "")) : "bgImage" == i ? jQuery("#bg").css({
